...
func CatNo(v *graph.Vertex) int64 { i, _ := v.U.(int64); return i }
...
func Roget(n, minDistance, prob, seed int64) (*graph.Graph, error) {
	var mapping [MaxN + 1]*graph.Vertex // mapping[k]: vertex assigned to category k (nil if unselected)
