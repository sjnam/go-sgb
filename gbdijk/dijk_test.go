...
func smallGraph() *gbgraph.Graph {
	g := gbgraph.NewGraph(4)
...
func TestDijkstraHeuristic(t *testing.T) {
	...
	hh := func(v *gbgraph.Vertex) int64 {
		if v == d {
			return 0
		}
		return 0
...
func TestDijkstraMilesShortPath(t *testing.T) {
	g, _, err := gbmiles.Miles(128, 0, 0, 0, 0, 0, 0)
	if err != nil {
...
func TestDijkstraMilesHeuristic(t *testing.T) {
	...
	withHH := Dijkstra(uu, vv, g, func(v *gbgraph.Vertex) int64 { return 0 }, nil, nil)
	if plain != withHH {
