...
@ |Raman(p,q,typ,reduce)|는 각 정점의 차수가 |p+1|인 무향 그래프를 짓는다.
...
한다. 다시 말해 $x^2\=p\pmod q$인 정수 $x$가 있어야 한다. |typ=4|이면
거꾸로 |p|가 이차 잉여가 아니라야 한다.

@ |typ=0|을 주면 절차가 허용되는 가장 큰 |typ|(3이나 4)을 스스로 고르고, 고른
...
@ |Raman|의 뼈대다. 표를 세우고, |typ|을 고르거나 검사해 정점 수 |n|을 정한
...
@ |chooseType|은 |typ|을 고르거나 검사하고 정점 수 |n|과 |nFactor|를 정한다.
...
@ 네 |typ|의 정점 수 공식도 확인한다. |q+1|, ${1\over2}q(q+1)$,
